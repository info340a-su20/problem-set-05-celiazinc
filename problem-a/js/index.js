...
*/
function renderPaletteRow(colors, parentDom) {
	let newDiv = document.createElement('div');
	for (let index in colors) {
		let size = getElementWidth(parentDom) / colors.length;
		let colorbox = createColorBox(colors[index], size);
...
if (typeof module !== 'undefined' && module.exports) {
	/* eslint-disable */
	if (typeof createColorBox !== 'undefined') module.exports.createColorBox = createColorBox;
	if (typeof renderPaletteRow !== 'undefined') module.exports.renderPalette = renderPaletteRow;
}
